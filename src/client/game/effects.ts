  ...
  onFx(kind: string, p: [number, number, number], a?: number, b?: number): void {
    ...
    switch (kind) {
      ...
      default:
        ...
        if (!aquaticFx(this.g, kind, p) && !illagerFx(this.g, kind, p, a) && !copperFx(this.g, kind, p) && !equipmentFx(this.g, kind, p, a, b)) faunaFx(this.g, kind, p, a); // Fase 6 (asaltos), 6.5 (cobre)
    }
  }
