...
import {
  ...
  RED_MUSHROOM_BLOCK, BROWN_MUSHROOM_BLOCK, MUSHROOM_STEM, CACTUS, SUGAR_CANE, PUMPKIN, MELON, CARVED_PUMPKIN, POPPY, DANDELION, CORNFLOWER, RED_MUSHROOM,
...
set(0.5, [CACTUS, SUGAR_CANE, MELON_SLICE, DEAD_BUSH, VINE]);
